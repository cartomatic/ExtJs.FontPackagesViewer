...
folder are mapped to the application's root namespace, 'FontPackagesViewer'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "FontPackagesViewer"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'FontPackagesViewer' in the same way
as `"FontPackagesViewer/sass/src"`.
